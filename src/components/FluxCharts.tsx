...
export const DonutChartWidget: React.FC<DonutChartProps> = ({
  ...
  return (
    <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 flex flex-col items-center justify-center h-full">
      {title && (
        <h3 className="text-lg font-semibold text-slate-800 mb-2 tracking-tight w-full text-left">
          {title}
        </h3>
      )}
...
export const StatCard: React.FC<StatCardProps> = ({
  ...
  return (
    <div className="relative overflow-hidden bg-white rounded-3xl shadow-sm border border-slate-100 h-48 transition-all hover:shadow-md">
      <div className="relative z-10 p-6 flex flex-col h-full justify-between pointer-events-none">
        <div>
          <h4 className="text-slate-500 font-medium text-sm tracking-wide uppercase">
            {label}
          </h4>
          <div className="text-4xl font-bold text-slate-800 mt-2 tracking-tight">
            {value}
          </div>
        </div>
        {trend && (
