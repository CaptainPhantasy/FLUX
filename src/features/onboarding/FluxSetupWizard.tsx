// =====================================
// FLUX - Database Setup Wizard Feature
// Ported from flux-database-wizard prototype
// =====================================
...
// Extended type to include postgres option
type DbType = StorageMode | 'postgres';
...
export function FluxSetupWizard({ onComplete, defaultUrl, defaultKey }: FluxSetupWizardProps) {
                                        ...
                                        <div className="p-5 bg-emerald-500/10 border border-emerald-500/20 rounded-2xl flex gap-3">
                                            ...
                                            <div className="space-y-1">
                                                ...
                                                <p className="text-emerald-200/70 text-sm leading-relaxed">
                                                    Flux will initialize a local database within your browser. This data is private but will be lost if you clear your browser cache.
                                                </p>
                                            </div>
                                        </div>
                                    )}
